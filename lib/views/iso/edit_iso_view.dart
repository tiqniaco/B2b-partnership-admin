import 'package:b2b_partnership_admin/controller/iso/edit_iso_controller.dart';
...
class EditIsoView extends StatefulWidget {
  const EditIsoView({super.key});

  @override
  State<EditIsoView> createState() => _EditIsoViewState();
}

class _EditIsoViewState extends State<EditIsoView> {
  final controller = Get.put(EditIsoController());
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Edit Certification'.tr),
      ),
      body: GetBuilder<EditIsoController>(
