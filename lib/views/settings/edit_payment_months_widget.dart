...
class EditPaymentMonthsWidget extends StatelessWidget {
  const EditPaymentMonthsWidget({super.key, required this.months});
  final List<PaymentMonths> months;

  @override
  Widget build(BuildContext context) {
    Get.find<EditPaymentController>();
    return GetBuilder<EditPaymentController>(builder: (controller) {
      return Padding(
