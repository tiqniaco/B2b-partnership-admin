import 'package:b2b_partnership_admin/controller/settings/edit_payment_controller.dart';
...
import 'package:b2b_partnership_admin/views/settings/edit_payment_months_widget.dart';
...
class EditPaymentMethod extends StatelessWidget {
  EditPaymentMethod({super.key});

  final controller = Get.put(EditPaymentController());
  @override
  Widget build(BuildContext context) {
    return GetBuilder<EditPaymentController>(
      init: EditPaymentController(),
      builder: (EditPaymentController controller) {
        return Scaffold(
          appBar: AppBar(
